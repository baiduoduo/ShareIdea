...
public class viewStrategyAction extends ActionSupport  {
	...
	public String viewStrategy(){
		...
		String result = "{\"ideaTitle\":\"" + res[0] + "\",\"author\":\"" + res[1] + "\",\"upLoadTime\":\"" + res[2] + "\",\"commentCon\":\"" + res[3] + "\",\"ideaContent\":\"" + res[4] + "\",\"headImage\":\""+res[5]+"\",\"ideaId\":\""+res[6]+"\",\"ideaNum\":\""+res[7]+"\",\"userId\":\""+res[8]+"\" }";
