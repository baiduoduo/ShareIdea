    ...
    <script type="text/javascript">
     ...
     function sendToEmail(){
      ...
      function tosubmit(){
  	     ...
  	     var job = $("#myJob").attr("value");
  	     var mqTextarea = $("#mqTextarea").attr("value");
  	   alert(mqTextarea);
  	    // alert(job);
  	     job = job.replace(/[ ]/g,"");
  	     mqTextarea = mqTextarea.replace(/[ ]/g,"");
  	   	mqTextarea = mqTextarea.replace(/\n/g,"<br>");
  	  alert(mqTextarea);
  	     $("#myJob").attr("value",job);
  	     $("#mqTextarea").attr("value",mqTextarea);
  	    // alert(job);
  	     //alert(mqTextarea);
      ...
      //得到action中的数据
    	...
    	function initInformation(){
    	    ...
    	    $("#mqTextarea").attr("value",baseInformation.userSelfInformation  == "null" ? " ": baseInformation.userSelfInformation.replace(/<br>/g,"\n"));
