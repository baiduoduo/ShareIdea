		...
		<script type="text/javascript">
		 <%
		    ...
		    var baseInfo = {
		      ...
		      userJob:"<%=user.getUserProf()==null?"":user.getUserProf() %>",
		      userFens:"<%=user.getUserScore()==null?"0":user.getUserScore()%>",
		      headImageUrl:"<%=user.getHeadimage()==null?"./image/defaultHeadPortrait.jpg":user.getHeadimage()%>",
		      pageCount:"9"
		    }
		</script>
	</head>
			...
			<div class="main mt20">
				...
				<div class="head-name">
					...
					<div class="head-border fl">
						<img id="mqHeadImage" class="head-icon" src="">
					</div>
