...
$(document).ready(function(){ 
    ...
    prettyPrint();
    addDownLoadEvent();
    $("#bd-vs-btn").attr("href","viewStrategy_viewStrategy.action?ideaId="+jsonCodeInformation.ideaId);
});
function addDownLoadEvent(){
	$("#bd-load-btn").click(function(){
		...
		$("input[name=codeScore]").val(jsonCodeInformation.codeScore);
		$("input[name=codeUser]").val(jsonCodeInformation.author);
...
function shwoIdeaInfomation(){
  ...
  $("#capacity").html(jsonCodeInformation.codeSize);
