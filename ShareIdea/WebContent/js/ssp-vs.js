...
$(document).ready(function(){ 
    ...
    showIdea();
    showCode();
    $("#bd-main-myname").attr("href","IdeaInfo_showOtherSpaceIdea?viewUserId="+jsonCodeInformation.userId);
});
...
function showCode(){
  ...
  var length = (jasonCode.code === undefined)? 0 : jasonCode.code.length;
  for(var i = 0; i < length;i++){
    createCodeList(parent,jasonCode.code[i].codeName,jasonCode.code[i].userId,jasonCode.code[i].codeAuthor,jasonCode.code[i].codeId);
  }
}

function createCodeList(parent,name,userId,author,codeId){
  ...
  $(codeName).attr("href","CodeInfo_getViewCodeMsg?codeId="+codeId);
  ...
  $(codeAuthor).attr("href","IdeaInfo_showOtherSpaceIdea?viewUserId="+userId);
...
function showIdea(){
  ...
  $("#bd-edit-div").html(jsonCodeInformation.ideaContent.replace(/<br>/g, "\n"));
...
function showComment(){
  ...
  //createCmtBlock();
      ...
      $(function(){
    	  var ideaValue="";
    	  if(NickName === jsonCodeInformation.author){
        ...
        $(".bd-main-cmtcount").bind("click",function(){
         ...
         $("#bd-submit").click(function(){
            if($("#bd-mycmt-text").val()!=""){
            	...
            	codeCommentContent = codeCommentContent.replace("\n","<br>");
            	var jsondata = {
