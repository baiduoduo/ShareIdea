...
<html>
    ...
    var baseInfo = {
      ...
      ideaCount:"<%=user.getUserIdeaNo()==null?"0":user.getUserIdeaNo()%>",
      friendCount:"<%=user.getUserFriendNo()==null?"0":user.getUserFriendNo() %>",
      score:"<%=user.getUserScore()==null?"0":user.getUserScore()%>",
      lastLogin:"<%=user.getLastLoginTime()==null?"":user.getLastLoginTime() %>",
   	  headImage:"<%=user.getHeadimage() ==null?"./image/defaultHeadPortrait.jpg":user.getHeadimage() %>",
    }
	    ...
	    <div class="zh-main w">
	      <div class="zh-m w1100 bc">
	      	<div class="zh-main-header">
	      		<div class="zh-main-img w100 h100 bc pa">
	      			<img id="zh-headImag" style="width:100%;height:100%;" src=""/>
	      		</div>
